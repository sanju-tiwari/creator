      ...
      <div className=" max-w-7xl mx-auto " >
         ...
         <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((features , i )=>(
             <Card
                key={i}
                className="group transition-all duration-300 hover:scale-105  bg-gray-900/50 border-gray-800 hover:border-purple-500/50"
              >
                <CardContent className="p-6 sm:p-8">
                  <div
                    className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${features.color} rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}
                  >
                    <features.icon className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                  </div>
