...
import { Calendar, Eye, Heart, Loader2, MessageCircle, PlusCircle, TrendingUp, Users } from 'lucide-react';
...
export default function DashboardPage(){
  ...
  const { data: recentPosts, isLoading: postsLoading } = useConvexQuery(api.dashboard.getPostsWithAnalytics,{ limit: 5 });
  const { data: recentActivity, isLoading: activityLoading } = useConvexQuery(api.dashboard.getRecentActivity,{ limit: 8 });
    ...
    <div className="space-y-8 p-4 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className=' bg-gray-900/50 border-gray-800 hover:border-purple-500/50'>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
           ...
           <CardContent>
            <div className="text-2xl font-bold text-white">
              {stats.tokenViews.toLocaleString()}
            </div>
            {stats.viewsGrowth > 0 && (
          ...
          <CardContent>
            <div className="text-2xl font-bold text-white">
              {stats.tokenLikes.toLocaleString()}
            </div>
            {stats.likesGrowth > 0 && (
              <div className="flex items-center text-xs text-green-400 mt-1">
             ...
             {postsLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <div className='space-y-4'>
                      ...
                      <div key={post._id} className="flex items-center justify-between p-4 bg-slate-800/30 hover:bg-slate-700/30 cursor-pointer rounded-lg transition-colors"  onClick={() => window.open( `/dashboard/posts/edit/${post._id}`,"_self")} >
