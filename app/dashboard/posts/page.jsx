...
export default function PostsPage(){
  ...
  const filterdata = React.useMemo(()=>{
    ...
    console.log( "hey this is me post " , posts)
     ...
     <CardContent className='p-6'>
          <div className="flex flex-col md:flex-row gap-4">
           <div className="relative flex-1">
            ...
            <Input placeholder='search Post...' className='pl-10 bg-slate-800 border-slate-600' value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}  />
           </div>
